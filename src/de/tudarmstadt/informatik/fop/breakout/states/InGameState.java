...
public class InGameState extends GameState {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
		...
		bResume = new Button(new Vector2f(400, 100), 60, 10, new Image("images/stick.png"), new Image("images/stick.png"), new ButtonAction() {
		...
		bMainScreen = new Button(new Vector2f(400, 200), 60, 10, new Image("images/stick.png"), new Image("images/stick.png"), new ButtonAction() {
			@Override
			public void action(GameContainer container, StateBasedGame game, GameState state, int delta) {
